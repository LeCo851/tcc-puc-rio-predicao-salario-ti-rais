...
class SetorIbgeEnum(str, Enum):
    ADM_PUBLICA = "Administraçao pública direta e autárquica"
    AGRICULTURA = "Agricultura, silvicultura, criaçao de animais, extrativismo vegetal"
    COMERCIO_IMOVEIS_TECH = "Com. e administraçao de imóveis, valores mobiliários, serv. Técnico"
    COMERCIO_ATACADISTA = "Comércio atacadista"
    COMERCIO_VAREJISTA = "Comércio varejista"
    CONSTRUCAO_CIVIL = "Construçao civil"
    ENSINO = "Ensino"
    EXTRATIVA_MINERAL = "Extrativa mineral"
    IND_BORRACHA_COURO = "Ind. da borracha, fumo, couros, peles, similares, ind. diversas"
    IND_QUIMICA_FARMACEUTICA = "Ind. química de produtos farmacêuticos, veterinários, perfumaria"
    IND_MADEIRA_MOVEIS = "Indústria da madeira e do mobiliário"
    IND_CALCADOS = "Indústria de calçados"
    IND_ALIMENTOS_BEBIDAS = "Indústria de produtos alimentícios, bebidas e álcool etílico"
    IND_MINERAIS_NAO_MET = "Indústria de produtos minerais nao metálicos"
    IND_TRANSPORTE = "Indústria do material de transporte"
    IND_ELETRICA_COMUNIC = "Indústria do material elétrico e de comunicaçoes"
    IND_PAPEL_GRAFICA = "Indústria do papel, papelao, editorial e gráfica"
    IND_MECANICA = "Indústria mecânica"
    IND_METALURGICA = "Indústria metalúrgica"
    IND_TEXTIL = "Indústria têxtil do vestuário e artefatos de tecidos"
    INST_FINANCEIRAS = "Instituiçoes de crédito, seguros e capitalizaçao"
    SERVICOS_GERAIS = "Serv. de alojamento, alimentaçao, reparaçao, manutençao, redaçao"
    UTILIDADE_PUBLICA = "Serviços industriais de utilidade pública"
    SAUDE_VETERINARIA = "Serviços médicos, odontológicos e veterinários"
    TRANSPORTES_COMUNIC = "Transportes e comunicaçoes"
    OUTROS = "Outros / Ignorado"
...
class CargoEnum(str, Enum):
    ...
    # --- NOVO ENUM ---
class FaixaExperienciaEnum(str, Enum):
    JUNIOR = "JUNIOR"
    PLENO = "PLENO"
    SENIOR = "SENIOR"
